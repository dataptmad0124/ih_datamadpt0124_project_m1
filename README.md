...
- Daniele: `/catalogo/202162-0-instalaciones-accesibles-municip.json`

- Elena: `/catalogo/202180-0-instalaciones-accesibles-no-muni.json`

- Juan Carlos: `/catalogo/202311-0-colegios-publicos.json`

- Juan Manual: `/catalogo/203166-0-universidades-educacion.json`

- Mario: `/catalogo/200215-0-instalaciones-deportivas.json`

- Valeriia: `/catalogo/200304-0-centros-culturales.json`

- Veronica: `/catalogo/201000-0-embajadas-consulados.json`

- Victor: `/catalogo/300356-0-monumentos-ciudad-madrid.json`
